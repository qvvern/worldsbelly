...
namespace WorldsBelly.DataAccess.Migrations
{
    ...
    [Migration("20220430122543_tagandtranslation")]
    partial class tagandtranslation
    {
            ...
            modelBuilder.Entity("WorldsBelly.DataAccess.Entities.Tag", b =>
                {
                    ...
                    b.Property<bool?>("LimitedToIngredient")
                        .HasColumnType("bit");

                    b.Property<bool?>("LimitedToRecipe")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("WorldsBelly.DataAccess.Entities.TagSelectableCategory", b =>
                {
                    b.HasOne("WorldsBelly.DataAccess.Entities.EnglishTranslation", "Text")
                        .WithOne()
                        .HasForeignKey("WorldsBelly.DataAccess.Entities.TagSelectableCategory", "TextId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
