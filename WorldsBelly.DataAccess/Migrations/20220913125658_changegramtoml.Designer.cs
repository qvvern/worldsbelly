...
namespace WorldsBelly.DataAccess.Migrations
{
    ...
    [Migration("20220913125658_changegramtoml")]
    partial class changegramtoml
    {
            ...
            modelBuilder.Entity("WorldsBelly.DataAccess.Entities.Ingredient", b =>
                {
                    ...
                    b.Property<double?>("OneCentimeterInMilligram")
                        .HasColumnType("float");

                    b.Property<double?>("OneCentimeterInMilliliter")
                        .HasColumnType("float");

                    b.Property<double?>("OneMilliliterInMilligram")
                        .HasColumnType("float");

                    b.Property<double?>("OnePieceInCentimeter")
                        .HasColumnType("float");

                    b.Property<double?>("OnePieceInMilligram")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("WorldsBelly.DataAccess.Entities.RecipeIngredient", b =>
                {
                    ...
                    b.Property<double>("AmountPerPortionDefaultMeasurement")
                        .HasColumnType("float");
