...
namespace WorldsBelly.DataAccess.Migrations
{
    ...
    [Migration("20230209134821_notifications")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorldsBelly.DataAccess.Entities.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("ActionUrlLabel")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("WorldsBelly.DataAccess.Entities.NotificationTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WorldsBelly.DataAccess.Entities.NotificationTemplateTranslation", b =>
                {
                    b.Property<int>("TemplateId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WorldsBelly.DataAccess.Entities.NotificationType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WorldsBelly.DataAccess.Entities.Recipe", b =>
                {
                    ...
                    b.Property<int>("CalculatedTotalRatings")
                        .HasColumnType("int");

                    b.Property<int>("CalculatedTotaliked")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WorldsBelly.DataAccess.Entities.RecipeCommentTranslation", b =>
                {
                    ...
                    b.ToTable("RecipeCommentTranslations");
                });
            ...
            modelBuilder.Entity("WorldsBelly.DataAccess.Entities.RecipeLike", b =>
                {
                    b.Property<int>("RecipeId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WorldsBelly.DataAccess.Entities.Notification", b =>
                {
                    b.HasOne("WorldsBelly.DataAccess.Entities.User", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WorldsBelly.DataAccess.Entities.User", "Sender")
                        .WithMany()
                        .HasForeignKey("SenderId");

                    b.HasOne("WorldsBelly.DataAccess.Entities.NotificationType", "Template")
                        .WithMany()
            ...
            modelBuilder.Entity("WorldsBelly.DataAccess.Entities.NotificationTemplate", b =>
                {
                    b.HasOne("WorldsBelly.DataAccess.Entities.NotificationType", null)
                        .WithMany("Templates")
                        .HasForeignKey("NotificationTypeId");

                    b.HasOne("WorldsBelly.DataAccess.Entities.NotificationType", "Type")
                        .WithMany()
                        .HasForeignKey("TypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WorldsBelly.DataAccess.Entities.NotificationTemplateTranslation", b =>
                {
                    ...
                    b.HasOne("WorldsBelly.DataAccess.Entities.NotificationTemplate", "Template")
                        .WithMany("Translations")
                        .HasForeignKey("TemplateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WorldsBelly.DataAccess.Entities.RecipeCommentTranslation", b =>
                {
                    b.HasOne("WorldsBelly.DataAccess.Entities.RecipeComment", "Comment")
                        .WithMany("Translations")
